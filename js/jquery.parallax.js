...
(function(jQuery, undefined) {
	...
	var options = {
	    	...
	    	xparallax:	0.1,      // boolean | 0-1 | 'npx' | 'n%' - Sets axis of reaction and by how much they react
	    	yparallax:	0.1,      //
	    	xorigin:		0,       // 0-1 - Sets default alignment. Only has effect when parallax values are something other than 1 (or true, or '100%')
	    	yorigin:		0.1,       //
	    	decay:			0.90,      // 0-1 (0 instant, 1 forever) - Sets rate of decay curve for catching up with target mouse position
	    	frameDuration:	1,    // Int (milliseconds)
